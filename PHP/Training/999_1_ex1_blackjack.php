<?php
    ...
    while(true) {
        ...
        if($input === 0) {
            ...
            $card_token = strtok( $card_result, '_' );
            $user_score = 0;
            if ( $card_token === "A" ) {
                $user_score += 1;
            } else if ( $card_token === "K" || $card_token === "Q" || $card_token === "J" ) {
                $user_score += 10;
            } else if ( $card_token == 2 ) {
                $user_score += 2;
            } else if ( $card_token == 3 ) {
                $user_score += 3;
            } else if ( $card_token == 4 ) {
                $user_score += 4;
            } else if ( $card_token == 5 ) {
                $user_score += 5;
            } else if ( $card_token == 6 ) {
                $user_score += 6;
            } else if ( $card_token == 7 ) {
                $user_score += 7;
            } else if ( $card_token == 8 ) {
                $user_score += 8;
            } else if ( $card_token == 9 ) {
                $user_score += 9;
            } else if ( $card_token == 10 ) {
                $user_score += 10;
            }
            echo $user_score;
        }
